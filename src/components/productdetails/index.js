                        ...
                        <li className='list-container-products' key={item.id}>
                            ...
                            <h3 className='list-item-tittle'>{item.title}</h3>
                                <button className='button-heart' onClick={() => toggleLike(item.id)}>
                                    <FaHeart className={`icon-heart ${likedItems.includes(item.id) ? 'liked' : 'unliked'}`} />
                                </button>
                            </div>
                            <p className='item-list-descreption'><a href='_'>sign in </a>or Create an account to see pricing</p>
                        </li>
                    ))}
                </ul>
            </div>
